...
import { selectBoxDefaultOptions } from "../../utils/types";

export default function SelectBox(props: selectBoxDefaultOptions) {
  return (
    <Listbox value={props.value?.value} onChange={props.onChange}>
