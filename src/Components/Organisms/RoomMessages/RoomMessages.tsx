...
function RoomMessages(props: messageType) {
  ...
  return (
    <div
      className={
        message.isOwnMessage ? styles.msg_container : styles.user_msg_container
      }
    >
      <div className={styles.img_box}>
        <img
          src={message.isOwnMessage ? main_image : user_image}
          alt=""
      ...
      {message.status ? (
        <div
          className={
            message.isOwnMessage ? styles.msg_box : styles.user_msg_box
          }
        >
